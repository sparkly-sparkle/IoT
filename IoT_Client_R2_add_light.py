...
#try:
    #while True:
        # read the light sensor value (0 to 1023)
...
def piSensor(sense,sleepCheck,count2):
    ...
    sound1 = ("%.2f" %sound1)
    light1 = grovepi.analogRead(light_sensor)
    light1 = ("%.2f" %light1)
    ...
    while True:
        ...
        sound2 = ("%.2f" %sound2)
        light2 = grovepi.analogRead(light_sensor)
        light2 = ("%.2f" %light2)
        ...
        if temp1 != temp2:
            ...
            temp1 = ("%.2f" %temp1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp2),str(press1),str(humid1),str(gyro1),str(accel1),str(magn1),str(dist1),str(sound1),str(light1)]
        
        if press1 != press2:
            temp1 = sense.get_temperature()
            temp1 = ("%.2f" %temp1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press2),str(humid1),str(gyro1),str(accel1),str(magn1),str(dist1),str(sound1),str(light1)]
        
        if humid1 != humid2:
            humid1 = sense.get_humidity()
            humid1 = ("%.2f" %humid1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid2),str(gyro1),str(accel1),str(magn1),str(dist1),str(sound1),str(light1)]
    
        if gyro1 != gyro2:
            gyro1 = sense.get_gyroscope()
            #gyro1 = ("%.2f" %gyro1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro2),str(accel1),str(magn1),str(dist1),str(sound1),str(light1)]
        
        if accel1 != accel2:
            accel1 = sense.get_accelerometer()
            #accesl1 = ("%.2f" %accel1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro1),str(accel2),str(magn1),str(dist1),str(sound1),str(light1)]
        
        if magn1 != magn2:
            magn1 = sense.get_compass()
            magn1 = ("%.2f" %magn1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro1),str(accel1),str(magn2),str(dist1),str(sound1),str(light1)]
        
        if dist1 != dist2:
            dist1 = read_distance()
            dist1 = ("%.2f" %dist1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro1),str(accel1),str(magn1),str(dist2),str(sound1),str(light1)]
        
        if sound1 != sound2:
            sound1 = grovepi.analogRead(sound_sensor)
            sound1 = ("%.2f" %sound1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro1),str(accel1),str(magn1),str(dist1),str(sound2),str(light1)]
        
        if light1 != light2:
            light1 = grovepi.analogRead(light_sensor)
            light1 = ("%.2f" %light1)
            count1=1
            dataF=[str(datetime.datetime.now().date()),str(datetime.datetime.now().hour),str(datetime.datetime.now().minute),str(datetime.datetime.now().second),str(datetime.datetime.now().microsecond),str(temp1),str(press1),str(humid1),str(gyro1),str(accel1),str(magn1),str(dist1),str(sound1),str(light2)]
